...
`reviewer-proof-summary.json` condenses the core local boundary, runtime network, production preview, ZIP export, responsive, and launch-gate evidence into one small reviewer-facing file.
