...
function fallbackFromModelText(raw: string, prompt: string): WorkspaceFiles {
  ...
  return {
    ...
    css: `body{margin:0;min-height:100vh;display:grid;place-items:center;background:#0b0f17;color:#f7fbff;font-family:-apple-system,BlinkMacSystemFont,"SF Pro Display","SF Pro Text","Segoe UI",Inter,system-ui,sans-serif;font-synthesis:none;line-height:1.42;text-rendering:optimizeLegibility;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}.model-fallback{width:min(780px,calc(100vw - 32px));display:grid;gap:16px;padding:32px;border:1px solid rgba(255,255,255,.16);border-radius:28px;background:rgba(255,255,255,.08);backdrop-filter:blur(24px)}.eyebrow{color:#9bd3ff;text-transform:uppercase;letter-spacing:0;font-size:12px;font-weight:750}h1{max-width:12ch;font-size:clamp(36px,5vw,50px);line-height:1;margin:0;letter-spacing:0;font-weight:820}pre{white-space:pre-wrap;max-height:300px;overflow:auto;color:#c9d8ef;font-size:14px;line-height:1.55}button{min-height:48px;border:0;border-radius:16px;background:#9bd3ff;color:#07111e;font-weight:760}@media(max-width:720px){h1{font-size:38px}}`,
